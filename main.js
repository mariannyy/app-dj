...
function gotPoses(results){
    ...
    {
        console.log(results);
        scoreRighthWrist=results[0].pose.keypoints[10].score;
        scoreLeftWrist=results[9].pose.keypoints[10].score;
        console.log("scoreRightWrist =" + scoreRightWrist + "scoreLeftWrist ="+ scoreLeftWrist);

        rightWristX = results[0].pose.rightWrist.x;
        rightWristY = results[0].pose.rightWrist.y;
        console.log("rightWristX =" + rightWrist.x +"rightWristY="+ rightWristY);

        leftWristX = results[0].pose.leftWrist.x;
        leftWristY = results[0].pose.leftWrist.y;
        console.log("leftWristX =" + leftWrist.x +"leftWristY="+ leftWristY); 
    }
}
...
if(scoreLeftWrist> 0.2)
{
    ...
    InNumberleftWristY=Number(leftWristY);remove_decimals=floor(InNumberleftWristY);
